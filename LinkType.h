#ifndef _DESPERADO_LINKTYPE_H_
#define _DESPERADO_LINKTYPE_H_
...
/******************************************************************************
    ...
    $Id: LinkType.h,v 1.7 2007/01/10 23:00:16 jsloan Exp $
...
public:
     ...
     */
    bool initialize(_TYPE_* object = 0);
...
//
template <typename _TYPE_>
inline bool LinkType<_TYPE_>::initialize(_TYPE_* object) {
    bool rc = false;
    try {
        this->LinkType<_TYPE_>::~LinkType();
        new(this) LinkType<_TYPE_>(object);
        rc = true;
    } catch (...) {
        rc = false;
    }
