...
#
#	@memo	Desperado Diminuto Platform Makefile
#
...
LDLIBRARIES	=	-Wl,-Bstatic -Wl,-l$(LIBRARY) $(ADJUNCTLIBRARY) -Wl,-Bstatic -Wl,-lpthread -Wl,-Bstatic -Wl,-lrt -Wl,-Bstatic -Wl,-lm
endif
...
CINCPATH	=	/opt/diminuto/buildroot/usr/include
CXXINCPATH	=	/opt/diminuto/buildroot/usr/$(GCCMACHINE)/include/c++/$(GCCVERSION)
