#ifndef _DESPERADO_WRITES_H_
#define _DESPERADO_WRITES_H_
...
/******************************************************************************
    ...
    $Id: writes.h,v 1.20 2006/01/09 00:24:49 jsloan Exp $
 ...
 *  @file
 *
 *  Implements the writes inline function. This can be included
...
CXXCINLINE ssize_t writes(
    ...
    here = staticcastto(const char*, pointer);
    remaining = nomore;
    total = 0;
