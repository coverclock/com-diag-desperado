#ifndef _DESPERADO_TRANSLITERATER_H_
#define _DESPERADO_TRANSLITERATER_H_
...
/******************************************************************************
    ...
    $Id: Transliterator.h,v 1.24 2006/02/07 00:07:03 jsloan Exp $
...
public:
     ...
     */
    virtual bool initialize(uint8_t* st = 0, unsigned int co = 0);
