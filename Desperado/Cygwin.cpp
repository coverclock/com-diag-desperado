...
/******************************************************************************
    ...
    $Id: Cygwin.cpp,v 1.8 2006/09/07 16:09:01 jsloan Exp $
...
//
void Cygwin::frequency(ticks_t& numerator, ticks_t& denominator) {
...
//
ticks_t Cygwin::yield(ticks_t ticks, bool premature) {
...
//
const char* Cygwin::errormessage(int errndx, char* buffer, size_t buflen) {
...
//
void Cygwin::show(int level, Output* display, int indent) const {
