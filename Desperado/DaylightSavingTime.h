#ifndef _COM_DIAG_DESPERADO_DAYLIGHTSAVINGTIME_H_
#define _COM_DIAG_DESPERADO_DAYLIGHTSAVINGTIME_H_
...
/******************************************************************************
    ...
    $Id: DaylightSavingTime.h,v 1.17 2006/02/07 00:07:03 jsloan Exp $
 ...
 *  @file
 *
 *  Declares the DaylightSavingTime class.
 *
 ...
 */
class DaylightSavingTime : public Object {
...
public:
     ...
     *  Constructor.
     */
    explicit DaylightSavingTime();

    /**
     *  Destructor.
     */
    virtual ~DaylightSavingTime();
