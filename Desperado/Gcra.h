#ifndef _DESPERADO_GCRA_H_
#define _DESPERADO_GCRA_H_
...
/******************************************************************************
    ...
    $Id: Gcra.h,v 1.10 2007/01/31 18:47:46 jsloan Exp $
...
public:
     ...
     *  @return true if successful, false otherwise.
     */
    virtual bool initialize(ticks_t increment, ticks_t limit);
