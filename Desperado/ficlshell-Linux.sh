...
#   $Name:  $
#
#   $Id: ficlshell-Linux.sh,v 1.1 2006/01/09 00:24:49 jsloan Exp $
#
###############################################################################
...
#   that will be used for the symbol. On some platforms these
#   will be the same thing, but not all.
#
...
for FILE in $*; do
    nm ${FILE} | awk '($2~/^[BDT]$/)&&($3!~/^_/) { print $3, $3; }'
done
