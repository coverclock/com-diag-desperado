...
/******************************************************************************
    ...
    $Id: DstNever.cpp,v 1.6 2006/02/07 00:07:03 jsloan Exp $
...
//
bool DstNever::operator() (const DateTime& /* dt */) const {
    return false;
}
...
//
void DstNever::show(int level, Output* display, int indent) const {
