#ifndef _DESPERADO_JAVAVIRTUALMACHINE_H_
#define _DESPERADO_JAVAVIRTUALMACHINE_H_
...
/******************************************************************************
    ...
    $Id: JavaVirtualMachine.h,v 1.6 2006/09/16 16:39:55 jsloan Exp $
...
public:
     ...
     */
    virtual bool initialize(bool ign = false, Output* out = 0);
