...
/******************************************************************************
    ...
    $Id: DstAlways.cpp,v 1.6 2006/02/07 00:07:03 jsloan Exp $
 ...
 *  @file
 *
 *  Implements the DstAlways class.
 *
 *  @see    DstAlways
 *
...
//
bool DstAlways::operator() (const DateTime& /* dt */) const {
    return true;
}
...
//
void DstAlways::show(int level, Output* display, int indent) const {
