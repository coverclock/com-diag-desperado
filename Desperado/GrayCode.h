#ifndef _DESPERADO_GRAYCODE_H_
#define _DESPERADO_GRAYCODE_H_
...
/******************************************************************************
    ...
    $Id: GrayCode.h,v 1.25 2006/02/07 00:07:03 jsloan Exp $
...
//
template <typename _TYPE_>
bool GrayCode<_TYPE_>::initialize() {
    bool rc = false;
    try {
        this->GrayCode<_TYPE_>::~GrayCode();
        new(this) GrayCode<_TYPE_>();
        rc = true;
    } catch (...) {
        rc = false;
    }
