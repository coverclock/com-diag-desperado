#ifndef _DESPERADO_LOCALTIME_H_
#define _DESPERADO_LOCALTIME_H_
...
/******************************************************************************
    ...
    $Id: LocalTime.h,v 1.26 2006/02/07 00:07:03 jsloan Exp $
...
public:
     ...
     *  @return true if successful, false otherwise.
     */
    virtual bool initialize(int32_t ot);
     ...
     *  @return true if successful, false otherwise.
     */
    virtual bool initialize(int32_t ot, DaylightSavingTime& re);
