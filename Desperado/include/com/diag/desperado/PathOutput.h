#ifndef _COM_DIAG_DESPERADO_PATHOUTPUT_H_
#define _COM_DIAG_DESPERADO_PATHOUTPUT_H_
...
/******************************************************************************
    ...
    $Id: PathOutput.h,v 1.16 2006/02/07 00:07:03 jsloan Exp $
 ...
 *  being a special one, "-", that denotes standard output.
 *
 *  @author coverclock@diag.com (Chip Overclock)
 */
class PathOutput : public FileOutput {
...
public:
     ...
     */
    explicit PathOutput(const char* path = "-", const char* mode = "w");

    /**
     *  Destructor. If standard output was not specified as the path,
     ...
     */
    virtual bool initialize(const char* path = "-", const char* mode = "w");
