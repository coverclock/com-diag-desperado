#ifndef _COM_DIAG_DESPERADO_WORD_H_
#define _COM_DIAG_DESPERADO_WORD_H_
 ...
 *  ASCII characters that are seperated by whitespace: tab,
 *  newline, return, or space. Word seperation may be defeated
 *  by escaping a whitespace character, or enclosing the character
 *  sequence in matching single or double quotes. Unless escaped,
 *  the poundsign character begins an ignored comment which is
 ...
 */
class Word : public TransliteratorType<16> {
...
public:
     ...
     *  for parsing by this class. The body of this method is defined inline
     *  to expose the character string.
     *
     *  @return         a pointer to a NUL-terminated character string of
     *                  characters used as delimiters by this class.
     */
    virtual const char* delimiter() { return "\t\n\r "; }
     ...
     *  by this class. The body of this method is defined inline to expose
     *  the character string.
     *
     *  @return         a pointer to a NUL-terminated character string of
     *                  characters special to this class.
     */
    virtual const char* special() { return "\"#'\\"; }
