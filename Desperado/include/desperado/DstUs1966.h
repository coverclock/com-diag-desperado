#ifndef _COM_DIAG_DESPERADO_DSTUS1966_H_
#define _COM_DIAG_DESPERADO_DSTUS1966_H_
...
/******************************************************************************
    ...
    $Id: DstUs1966.h,v 1.16 2006/02/07 00:07:03 jsloan Exp $
...
#include "desperado/DstGeneric.h"


#include "desperado/Begin.h"

/**
 *  Encodes a rule to decide whether a given DateTime falls within US
 *  daylight saving time (DST) as defined in 1966.
 *
 *  @author coverclock@diag.com (Chip Overclock)
 */
class DstUs1966 : public DstGeneric {
