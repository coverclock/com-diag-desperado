#ifndef _DESPERADO_DUMPINPUT_H_
#define _DESPERADO_DUMPINPUT_H_
...
/******************************************************************************
    ...
    $Id: DumpInput.h,v 1.18 2006/02/07 00:07:03 jsloan Exp $
...
public:
     ...
     *  @return true if successful, false otherwise.
     */
    virtual bool initialize(Input& ri);
     ...
     *  @return true if successful, false otherwise.
     */
    virtual bool initialize(Input& ri, Dump& rd);
