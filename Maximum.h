...
/******************************************************************************
    ...
    $Id: Maximum.h,v 1.17 2006/01/09 00:24:48 jsloan Exp $
...
public:
    ...
    /**
     *  Return the maximum object in an argument list of
     *  at one objects.
     *
     *  @param  one         is the first object in the
     *                      argument list.
     *
     *  @return             the maximum object in the argument
     *                      list.
     */
    _TYPE_ operator() (
        _TYPE_ one
...
template <typename _TYPE_>
inline bool Maximum<_TYPE_>::less(
    _TYPE_ one,
    _TYPE_ two
) {
    return (one < two);
...
template <typename _TYPE_>
inline _TYPE_ Maximum<_TYPE_>::operator() (
    _TYPE_ one
) {
    return one;
}
...
inline _TYPE_ Maximum<_TYPE_>::operator() (
    ...
    return this->less(one, two) ? two : one;
}
