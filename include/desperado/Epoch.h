#ifndef _COM_DIAG_DESPERADO_EPOCH_H_
#define _COM_DIAG_DESPERADO_EPOCH_H_
...
/******************************************************************************
    ...
    $Id: Epoch.h,v 1.8 2006/02/07 00:07:03 jsloan Exp $
 ...
 *
 *  On most compilers, the virtual pointer will take up the
 *  slack between the double word seconds and the single word
 *  nanoseconds, hence it adds no memory overhead when arrays
 *  of objects of this type are used. Your mileage may vary.
 *
 *  @author coverclock@diag.com (Chip Overclock)
 */
class Epoch : public Object {
...
public:
     ...
     *  Constructor.
     *
     *  @param  sd      is the number of seconds.
     *
     *  @param  nd      is the fractional number of seconds in nanoseconds.
     */
    explicit Epoch(seconds_t sd = 0, uint32_t nd = 0);
     ...
     */
    virtual bool initialize(seconds_t sd = 0, uint32_t nd = 0);
     ...
     */
     ...
     /**
      *  This is the fractional number of seconds.
      */
...
//  Constructor.
//
inline Epoch::Epoch(seconds_t sd, uint32_t nd) :
    seconds(sd),
    nanoseconds(nd)
{
}
