#ifndef _DESPERADO_DSTGENERIC_H_
#define _DESPERADO_DSTGENERIC_H_
...
/******************************************************************************
    ...
    $Id: DstGeneric.h,v 1.12 2006/02/07 00:07:03 jsloan Exp $
...
public:
     ...
     *  @return true if successful, false otherwise.
     */
    virtual bool initialize(const Event& bs, const Event& es);
