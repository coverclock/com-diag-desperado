...
const char Vintage::copyright[] =   "$Copyright: Copyright 2006 Digital Aggregates Corp., Arvada CO 80001-0587, USA $";
...
const char Vintage::date[] =        "$Date: 2006/02/07 00:07:03 $";

const char Vintage::release[] =     "$Name:  $";
