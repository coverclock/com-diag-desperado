...
/******************************************************************************
    ...
    $Id: Argument.cpp,v 1.6 2006/02/07 00:07:02 jsloan Exp $
...
int Argument::vector(
    ...
    while (argc < maximum) {
        argv[argc] = ::strtok_r(s, delimiter, &pointer);
        if (0 == argv[argc]) {
            break;
        }
        s = 0;
...
//
void Argument::show(int /* level */, Output* display, int indent) const {
