...
/******************************************************************************
    ...
    $Id: unittestHeap2.c,v 1.18 2006/01/09 00:24:49 jsloan Exp $
 ...
 *  @file
 *
 *  Implements the Heap CXXCAPI unit test.
 *
 *  @see    Heap
 *
 ...
 *  could use the lowercasenames for the macros and convert
 *  legacy code to using these C-callable APIs to our own
 *  Heap object.
 */
